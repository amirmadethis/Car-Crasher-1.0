class PlayHard extends Phaser.Scene {
    ...
    create() {
        ...
        this.highScoreText = this.add.text(this.screenCenterX - 340, this.screenCenterY + 300, "HIGHSCORE: " + localStorage.getItem("HardHighScoreVar"), textConfig).setOrigin(0.5);
        this.score = 0;
        this.highScore = 0;
