class PlayNormal extends Phaser.Scene {
    constructor() {
        super("playNormalScene");
    }
    ...
    create() {
        ...
        this.highScoreText = this.add.text(this.screenCenterX - 340, this.screenCenterY + 300, "HIGHSCORE: " + localStorage.getItem("NormalHighScoreVar"), textConfig).setOrigin(0.5);
        this.score = 0;
        this.highScore = 0;
    ...
    update() {
        ...
        if (localStorage.getItem("NormalHighScoreVar") == null){
        ...
        if (this.lives == 0 && (this.score > localStorage.getItem("NormalHighScoreVar"))) {
    ...
    highScoreFunc() {
        if (this.score > localStorage.getItem("NormalHighScoreVar")) {
            localStorage.setItem("NormalHighScoreVar", this.score)
        }
    }
