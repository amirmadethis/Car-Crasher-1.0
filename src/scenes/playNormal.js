class PlayNormal extends Phaser.Scene {
    ...
    create() {
        ...
        this.highScoreText = this.add.text(this.screenCenterX - 360, this.screenCenterY + 35, "HIGHSCORE: " + localStorage.getItem("NormalHighScoreVar"), textConfig).setOrigin(0.5);
        this.score = 0;
        this.highScore = 0;
